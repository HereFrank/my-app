...
//Function that return the vault address
...
//Function that return the data account of a given listed nft (that has the wallet that list the nft and the price)

//Dudas: ¿Qué otro valid program address?
//still with doubts
//????
...
//Function that return the listed nfts ?
//????
...
//Input: Connection, PublicKey (connected wallet)

//Function that returns the listed nfts by adress owner?
//You can use it to see listed nfts of a connected wallet 
//(You can see useListedNfts.js hook)
